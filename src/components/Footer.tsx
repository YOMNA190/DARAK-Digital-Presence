      ...
      <div className="darak-container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-5">
            ...
            <div className="flex items-center gap-3">
              <a href="https://www.facebook.com/share/18jLCi4uBL/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-white/10 rounded-full flex items-center justify-center hover:bg-[var(--darak-gold)] transition-colors cursor-pointer">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-white/70 text-sm">darak1907k@gmail.com</span>
              </li>
              <li className="flex items-center gap-3">
