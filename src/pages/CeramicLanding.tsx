import { Check, Phone, MessageSquare, Shield, Clock, Award, Zap, Search, PenTool as Tool, Ruler, Star, AlertTriangle } from 'lucide-react';
...
const whyChooseUs = [
  {
    ...
    description: 'استواء تام للأسطح واستخدام أحدث الأدوات.',
    icon: Ruler,
  },
  {
    title: 'توحيد فواصل',
    description: 'بأدوات ليزر حديثة وفنيين متخصصين.',
    icon: Check,
  },
  {
    title: 'أسعار تنافسية',
    description: 'جودة عالية بسعر مناسب وعادل.',
    icon: Award,
  },
  {
    title: 'ضمان التركيب',
    description: 'نضمن جودة عملنا وسلامة التركيب.',
    icon: Shield,
  },
];
...
const processSteps = [
  {
    id: 1,
    title: 'تجهيز الأرضية',
    description: 'تنظيف وتسوية الأرضية لضمان استواء البلاط.',
    icon: Phone,
  },
  {
    id: 2,
    title: 'توزيع البلاط',
    description: 'توزيع البلاط بشكل متناسق قبل البدء في التركيب.',
    icon: Search,
  },
  {
    id: 3,
    title: 'التركيب بالليزر',
    description: 'تركيب دقيق باستخدام أدوات ليزر حديثة.',
    icon: Zap,
  },
  {
    id: 4,
    title: 'الترويبة النهائية',
    description: 'ملء الفواصل بمادة ترويبة عالية الجودة.',
    icon: Tool,
  },
];
...
const testimonials = [
  {
    name: 'سارة، الدمام',
    text: 'الفنيين كانوا دقيقين جداً في التركيب، الفواصل موحدة والبلاط مستوي تماماً. شغل احترافي.',
    rating: 5,
  },
  {
    name: 'علي، الخبر',
    text: 'استخدموا أدوات حديثة وفنيين محترفين. النتيجة طلعت أحسن من توقعاتي.',
    rating: 5,
  },
  {
    name: 'فاطمة، الظهران',
    text: 'سرعة في التنفيذ وجودة ممتازة. أنصح أي حد يركب سيراميك معهم.',
    rating: 5,
  },
];
...
const faqs = [
  {
    question: 'هل البورسلان شامل التوريد؟',
    answer: 'نوفر خدمة التوريد والتركيب أو التركيب فقط حسب رغبة العميل.',
  },
  {
    question: 'كم مدة تركيب سيراميك شقة؟',
    answer: 'تستغرق الشقة المتوسطة من 5 إلى 8 أيام عمل حسب المساحة.',
  },
  {
    question: 'ما الفرق بين السيراميك والبورسلان؟',
    answer: 'البورسلان أكثر متانة ومقاومة للامتصاص، بينما السيراميك يتوفر بتصاميم أكثر وتكلفة أقل.',
  },
  {
    question: 'هل تقدمون ضماناً على التركيب؟',
    answer: 'نعم، نضمن جودة التركيب والفواصل لمدة سنة.',
  },
];

export default function CeramicLanding() {
  const whatsappMessage = encodeURIComponent('السلام عليكم، أرغب في الاستفسار عن خدمات تركيب السيراميك من شركة دارك.');
  ...
  return (
    <main className="bg-white">
      <SEO 
        title="تركيب سيراميك وبورسلان بالدمام | دقة في كل بلاطة - شركة دارك"
        description="أفضل خدمات تركيب السيراميك والبورسلان في الدمام والخبر. دقة في التركيب، توحيد فواصل، وضمان على الأعمال. اتصل الآن."
        keywords="تركيب سيراميك بالدمام, بورسلان, فني سيراميك, دقة في التركيب, دارك للمقاولات"
      />
        ...
        <div className="relative z-10 darak-container px-4 py-20">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
              تركيب سيراميك وبورسلان <br />
              <span className="text-[var(--darak-gold)]">دقة في كل بلاطة</span>
            </h1>
            <p className="text-white/90 text-xl md:text-2xl mb-10 font-medium">
              دقة في التركيب | توحيد فواصل احترافي | ضمان على جودة العمل
            </p>
      ...
      <section className="py-24 bg-[var(--darak-offwhite)]">
        <div className="darak-container px-4">
          <div className="text-center mb-16">
            ...
            <p className="darak-body max-w-2xl mx-auto">نقدم حلولاً متكاملة لتركيب السيراميك والبورسلان بأعلى معايير الدقة.</p>
          </div>
      ...
      <section className="py-24 bg-[var(--darak-offwhite)]">
        <div className="darak-container px-4">
          <div className="text-center mb-16">
            ...
            <p className="darak-body">خطوات منظمة لضمان أفضل النتائج.</p>
          </div>
        ...
        <div className="darak-container px-4">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
            <div className="flex items-center gap-6">
              ...
              <div>
                <h2 className="text-3xl md:text-4xl font-bold mb-2">محتاج تركيب سيراميك احترافي؟</h2>
                <p className="text-xl text-white/90">نحن نضمن لك دقة متناهية في التركيب ومظهراً جمالياً يدوم طويلاً.</p>
              </div>
            </div>
            <div className="flex flex-wrap gap-4">
