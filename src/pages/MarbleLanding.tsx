...
export default function MarbleLanding() {
  ...
  return (
    <main className="bg-white">
      <SEO 
        title="تركيب رخام فاخر بالدمام | فخامة تدوم - شركة دارك"
        description="أفضل خدمات تركيب الرخام في الدمام والخبر. رخام إيطالي وصناعي، أرضيات، درج، وواجهات بضمان وجودة عالية. اتصل الآن."
        keywords="تركيب رخام بالدمام, رخام إيطالي, رخام صناعي, فني رخام, دارك للمقاولات"
      />
        ...
        <div className="relative z-10 darak-container px-4 py-20">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
              تركيب رخام فاخر <br />
              <span className="text-[var(--darak-gold)]">فخامة تدوم</span>
            </h1>
            <p className="text-white/90 text-xl md:text-2xl mb-10 font-medium">
              خامات مستوردة | فنيون متخصصون | ضمان سنة على التركيب
            </p>
